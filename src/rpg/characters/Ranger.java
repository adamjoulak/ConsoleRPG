...
public class Ranger extends Hero{
    ...
    public Ranger(String name) {
        this.name = name;
        this.lvl = 1;
        this.basePrimaryAttributes = new BasePrimaryAttributes(8,1,7,1);
        //this.totalPrimaryAttributes = new TotalPrimaryAttributes(5, 1, 1, 8);
        this.secondaryAttribute = new SecondaryAttribute(8,1,7, 1);
        setHealth(8);
    }
    ...
    public void levelUp() {
        setLvl(lvl+1);
        basePrimaryAttributes.setVitality(basePrimaryAttributes.getVitality() + 2);
        basePrimaryAttributes.setStrength(basePrimaryAttributes.getStrength() + 1);
        basePrimaryAttributes.setDexterity(basePrimaryAttributes.getDexterity() + 5);
